...
class ExpandableListAdapter(
    ...
    //TODO("The adapter needs to be made functional
    // https://www.youtube.com/watch?v=kC8VW3novLQ
    // is the video")
    ...
    override fun getGroupView(
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.expandablelistadapter_layout_group, null)
        }
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            val inflater =
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            convertView = inflater.inflate(R.layout.expandablelistadapter_layout_child, null)
        }
        val title = convertView?.findViewById<TextView>(R.id.tv_title)
